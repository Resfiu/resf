  ...
  const data = [
      ...
      content: (
        <div>
          <p className="mb-8 text-xs font-normal text-neutral-200 md:text-sm">
            {' '}
            Güzel bir iş bulmak yada kurmak ve devamlılığını getirmek
          </p>
      ...
      content: (
        <div>
          <p className="mb-4 flex flex-col text-xs font-normal text-neutral-200 md:text-sm">
            <span>American Express ile anlaşma yapmak </span>
            <span>Amerikan Express kartı kazanmak</span>
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-8 text-xs font-normal text-neutral-200 md:text-sm">
            Global bir şirket olmak , herkesin aklında yer edinmiş bir şirket olmak.
          </p>
          <p className="mb-8 text-xs font-normal text-neutral-200 md:text-sm">
            Aynı Apple ,Samsung ,Nvidia vb şirket olmak
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/previous-work/nvidia.png"
              alt="hero template"
              width={500}
              height={500}
              className="h-20 w-full rounded-lg object-cover shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] md:h-44 lg:h-60"
            ...
            />
            <Image
              src="/previous-work/microsoft.png"
              alt="cards template"
              width={500}
              height={500}
              className="h-20 w-full rounded-lg object-cover shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] md:h-44 lg:h-60"
